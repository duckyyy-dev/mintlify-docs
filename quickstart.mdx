---
description: "Complete guide to configuring Relay for your server. Set up permissions, credentials, bot settings, and trusted access to customize your experience."
title: "Configuration"
---

## **Configuration Overview**

Relay offers extensive configuration options to tailor the bot’s behavior to your server’s specific needs. Access all configuration options using the `/config` command.
